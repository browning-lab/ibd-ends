...
public class VcfIt<E extends GTRec> implements SampleFileIt<E> {
   ...
   /**
     ...
     */
    public static final BiFunction<VcfHeader, String, GTRec> TO_BITSET_GT
     ...
     */
    public static final BiFunction<VcfHeader, String, GTRec> TO_GL
     ...
     * to a {@code VcfRecord} object.
     */
    public static final BiFunction<VcfHeader, String, GTRec> TO_GTGL
     ...
     * to a {@code VcfRecord} object.
     */
    public static final BiFunction<VcfHeader, String, VcfRec> TO_VCF_RC
            = (VcfHeader h, String s) -> VcfRec.fromGTGL(h, s, DEFAULT_MAX_LR);
